...
{
	typename ft::vector<T>::iterator first = vector.begin();
	typename ft::vector<T>::iterator last = vector.end();
...
void print_map(ft::map<Key, T> &map)
{
	...
	std::cout << std::endl;
	std::cout << "Size: sdfwe" << map.size() << std::endl;
	std::cout << std::endl;
}
...
int main(void)
{
	...
	std::cout << "\e[104mREVERSE ITERATOR\e[0m" << std::endl;
	{
		...
		ft::vector<int>::reverse_iterator it = c.rbegin();
		ft::vector<int>::reverse_iterator ite = c.rend();
	...
	std::cout << "\e[103mMAP ITERATOR\e[0m" << std::endl;
	{
		...
		ft::map<int, std::string>::iterator it = c.begin();
		ft::map<int, std::string>::iterator ite = c.end();
		--ite;
	...
	std::cout << "\e[103mMAP REVERSE ITERATOR\e[0m" << std::endl;
	{
		...
		ft::map<int, std::string>::reverse_iterator it = c.rbegin();
		ft::map<int, std::string>::reverse_iterator ite = c.rend();
		--ite;
	...
	std::cout << "\e[103mMAP SWAP\e[0m" << std::endl;
	{
		...
		d.insert(ft::make_pair<int, std::string>(777, "Meu"));
		d.insert(ft::make_pair<int, std::string>(28, "Meu2"));
